  ...
  return (
    <div className="mt-20 px-16 md:px-24 lg:mt-40 lg:px-44">
      ...
      <div>
        ...
        <Link
          link="#edit-address"
          className="block w-full rounded-md bg-gray-700 py-12 px-16 text-center text-14 font-medium leading-[114%] text-neutral-150 hover:cursor-pointer md:w-fit 2xl:py-12 2xl:px-40"
        >
